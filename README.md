...
[![Methodology](https://img.shields.io/badge/methodology-v5.15-green.svg)](https://magistra.health/en/methodology)
...
**Goyal, S.** (2026). *A Dual-Track Framework for GLP-1 Side Effect Estimation: Separating Clinical Evidence from Real-World Patient Reports* (v5.15). Magistra, Phlo Systems BV. https://magistra.health/en/methodology
